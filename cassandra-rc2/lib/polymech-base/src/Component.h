...
public:
    ...
    Component() : name("NO_NAME"), id(0),
                  ...
                  pFlags(E_PersistenceFlags::E_PF_NONE),
                  sFlags(E_NetworkSyncFlags::E_NSF_NONE),
                  owner(nullptr),
                  slaveId(0) {}
     ...
     */
    Component(String _name, ushort _id, uint16_t _flags, Component *_owner, uint16_t featureFlags = E_NetworkValueFeatureFlags::E_NVFF_ALL) : name(_name),
                                                                                                                                              id(_id),
                                                                                                                                              flags(_flags),
                                                                                                                                              nFlags(OBJECT_NET_CAPS::E_NCAPS_NONE),
                                                                                                                                              owner(_owner),
    ...
    /**
     * @brief Virtual function to start the component.
     * @return The error code indicating the success or failure of the operation.
     */
    virtual short start()
    {
    ...
    /**
     * @brief Virtual function to pause the component.
     *
     * @return The error code indicating the success or failure of the operation.
     */
    virtual short pause()
    ...
    /**
     * @brief Virtual function to resume the component.
     * @return The error code indicating the success or failure of the operation.
     */
    virtual short resume()
    {
        return E_OK;
    };

    /**
     * @brief Virtual function to stop the component.
     * @return The error code indicating the success or failure of the operation.
     */
    virtual short stop()
    {
    ...
    /**
     * @brief Virtual function to restart the component.
     * @return The error code indicating the success or failure of the operation.
     */
    virtual short reset()
    {
    ...
    /**
     * @brief Enables a feature flag for the component.
     */
    void enableFeature(E_NetworkValueFeatureFlags flag) { SBI_MASK(fFlags, static_cast<uint8_t>(flag)); }

    /**
     * @brief Disables a feature flag for the component.
     */
    void disableFeature(E_NetworkValueFeatureFlags flag) { CBI_MASK(fFlags, static_cast<uint8_t>(flag)); }

    bool hasFeature(E_NetworkValueFeatureFlags flag) const
    {
        return TEST_MASK(fFlags, static_cast<uint8_t>(flag));
    }

    /**
     * @brief Enables a persistence flag for the component.
     */
    void enablePersistence(E_PersistenceFlags flag) { SBI_MASK(pFlags, static_cast<uint8_t>(flag)); }

    /**
     * @brief Disables a persistence flag for the component.
     */
    void disablePersistence(E_PersistenceFlags flag) { CBI_MASK(pFlags, static_cast<uint8_t>(flag)); }

    bool hasPersistence(E_PersistenceFlags flag) const
    {
        return TEST_MASK(pFlags, static_cast<uint8_t>(flag));
    }

    /**
     * @brief Enables a sync flag for the component.
     */
    void enableSync(E_NetworkSyncFlags flag) { SBI_MASK(sFlags, static_cast<uint8_t>(flag)); }

    /**
     * @brief Disables a sync flag for the component.
     */
    void disableSync(E_NetworkSyncFlags flag) { CBI_MASK(sFlags, static_cast<uint8_t>(flag)); }

    bool hasSync(E_NetworkSyncFlags flag) const
    {
        return TEST_MASK(sFlags, static_cast<uint8_t>(flag));
    }
    ...
    /**
     * @brief The persistence flags for the component.
     */
    uint16_t pFlags;

    /**
     * @brief The network sync flags for the component.
     */
    uint16_t sFlags;
...
public:
     ...
     */
    uint32_t getLoopDurationUs() const { return _loop_duration_us; }
};
...
Target component_cast(Source *src)
{
    if (src && src->is_type(Target::COMPONENT_TYPE_ENUM))
    {
