/**
  ...
  $Revision: 43323 b8c9137bd3ef7bcc6437110256bba039137f5046 $
  $Date: 2021-05-12 04:28:01 $
  
  FORKID {36E63822-3A79-42b9-96EA-6B661FE8D0C8}
*/

description = "Heidenhain_PH";
vendor = "Heidenhain_PH";
...
function setTolerance(tolerance) {
  ...
  if (tolerance > 0) {
    ...
    // Heidenhain Fucking Official Fuck Defaults:
    // writeBlock("CYCL DEF 32.0 " + localize("TOLERANCE")); // cancel tolerance // #PlasticHub
    // writeBlock("CYCL DEF 32.1"); // #PlasticHub

    // Changed for Blum cycles
    writeBlock("M19"); //Heidenhain fuck bug

    writeBlock("TCH PROBE 562 " + localize("TOOL SETTING L") + " ~" + EOL
      + "  Q350=+0" + " ;" + localize("MEASURING TYPE") + " ~" + EOL
      + "  Q361=2" + " ;" + localize("NUMBER OF MEASUREMEN") + " ~" + EOL
      + "  Q362=+0.005" + " ;" + localize("DISPERSION TOLERANCE")
      );
  }
}
