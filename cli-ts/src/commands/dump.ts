...
async function dumpModbusData(targetDir: string) {
    try {
...
async function fetchEndpoint(baseUrl: string, endpoint: string): Promise<any> {
...
export async function handler(argv: { targethost: string; directory: string, [key: string]: any }) {
