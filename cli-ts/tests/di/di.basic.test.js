...
import { buildFeatureCatalog, buildClassNameToFeatureMap, analyzeComponentDependencies } from '../../src/lib/di.js';
import path from 'path';
describe('Dependency Injection Analysis - Basic Units', () => {
    let projectRoot;
    let featureCatalog;
    let classNameToFeatureMap;
    let includeDirs;
    beforeAll(async () => {
...
//# sourceMappingURL=di.basic.test.js.map