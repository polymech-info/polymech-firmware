...
#define MB_OFFLINE_BACKOFF_INITIAL    10000  // Initial backoff: 10 seconds
#define MB_OFFLINE_BACKOFF_MAX       300000  // Maximum backoff: 5 minutes
